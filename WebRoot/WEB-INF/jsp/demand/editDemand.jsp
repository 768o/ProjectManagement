...
<body>
	<div class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<section class="panel"> <header class="panel-heading">编辑需求</header>

				<div class="panel-body">
					<form action="<%=basePath%>demand/updateDemand" class="form-horizontal adminex-form cmxform" id="postForm"  method="post" enctype="multipart/form-data">		
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input minlength="2" maxlength="20" type="text" name="demand_name"
									class="form-control required" placeholder="请填写名称" id="name" value="${demand.demand_name}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea maxlength="140" name="demand_depict"
									placeholder="请填写描述" style="height:90px;" class="form-control" id="depict" >${demand.demand_depict}</textarea>
							</div>
						</div>
						<div class="form-group">
