...
<body>
	<div class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<section class="panel"> <header class="panel-heading">添加产品</header>

				<div class="panel-body">
					<form action="<%=basePath%>product/addProduct" class="form-horizontal adminex-form cmxform" id="postForm"  method="post" enctype="multipart/form-data">
