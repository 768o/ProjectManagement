...
<html>
  ...
  <div class="page-heading">
      ...
      <div class="pull-right"><a href="<%=basePath%>jurisdiction/toAddJurisdiction" class="btn btn-success">+添加新权限</a></div>
      </div>
    <div class="wrapper">
      <div class="row">
        <div class="col-sm-12">
          <section class="panel">
            <header class="panel-heading"> 权限管理  <span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a>
                ...
                <form id="user-form-list">
                  <table class="table table-bordered table-striped table-condensed">
                    ...
                    <tr>
                      ...
                      <td>${jurisdiction.jurisdiction_depict}</td>
                      ...
                      <td><div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="<%=basePath%>jurisdiction/getJurisdiction?id=${jurisdiction.jurisdiction_id}">编辑</a></li>
                            
                            <li role="separator" class="divider"></li>
                            
                            <li><a href="javascript:del('${jurisdiction.jurisdiction_id }')">删除</a></li>
