...
<body>
	<div class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<section class="panel"> <header class="panel-heading">修改权限</header>

				<div class="panel-body">
					<form action="<%=basePath%>jurisdiction/updateJurisdiction" class="form-horizontal adminex-form cmxform" id="postForm"  method="post">
						<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label"><span>*</span>名称</label>
							<div class="col-sm-10">
							<input type="hidden" name="jurisdiction_id" value="${jurisdiction.jurisdiction_id}"/>
								<input minlength="2" maxlength="50" type="text" name="jurisdiction_name"
									class="form-control required" placeholder="请填写名称" id="name" value="${jurisdiction.jurisdiction_name}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea maxlength="140" name="jurisdiction_depict"
									placeholder="请填写描述" style="height:90px;" class="form-control" id="depict"
									 >${jurisdiction.jurisdiction_depict}</textarea>
							</div>
						</div>
						<div class="form-group">
