...
<html>
  <head>
   ...
   <script type="text/javascript">
	function del(id){
		...
		$.get("<%=basePath%>department/delDepartment?id=" + id,function(data){
  ...
  <body>
   <div class="page-heading">
      ...
      <div class="pull-right"><a href="<%=basePath%>department/toAddDepartment" class="btn btn-success">+添加新部门</a></div>
       </div>
    <div class="wrapper">
      <div class="row">
        <div class="col-sm-12">
          <section class="panel">
            <header class="panel-heading"> 部门管理  <span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a>
                ...
                <form id="user-form-list">
                  <table class="table table-bordered table-striped table-condensed">
                    ...
                    <tr>
                      ...
                      <td>${department.department_depict}</td>
                      ...
                      <td><div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="<%=basePath%>department/getDepartment?id=${department.department_id}">编辑</a></li>
                            
                            <li role="separator" class="divider"></li>
                            
                            <li><a href="javascript:del('${department.department_id }')">删除</a></li>
