		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel-body">
					<form action="<%=basePath%>user/addUser" class="form-horizontal adminex-form cmxform" id="postForm"  method="post">
						<header>
						<b> 添加员工 </b></header>
						<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label"><span>*</span>姓名</label>
							<div class="col-sm-10">
								<input minlength="2" maxlength="20" type="text" name="user_name" value=""
									class="form-control required" placeholder="请填写姓名">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label"><span>*</span>账号</label>
							<div class="col-sm-10">
								<input minlength="4" maxlength="20" type="text" name="user_loginName"
